...
try:
   ...
   print('driver fail to initalise')
...
def read_voice_cmd():
     ...
     with sr.Microphone() as source:
          ...
          speech.adjust_for_ambient_noise(source, duration=5)
...
if __name__ == '__main__':
    ...
    speak_text_cmd('Hello Sir. This is your personal Asssistance')
    ...
    while True:
        ...
        if 'hello' in voice_note:
            ...
            continue
             ...
             speak_text_cmd('Bye have a good day')
             exit()